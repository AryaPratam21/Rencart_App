    ...
    try {
      ...
      if (user != null && user.$id != 'guest') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Login gagal: Anda masih dianggap guest. Silakan coba lagi.')),
        );
      }
    } catch (e) {
      if (!mounted) return;
      String message = e is Exception && e.toString().contains('AppwriteException')
          ? e.toString().replaceAll('Exception: ', '')
          : (e is Error ? e.toString() : 'Login gagal. Cek email & password.');
