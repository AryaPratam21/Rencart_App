...
class OwnerBookingListMultiSelectScreen extends ConsumerStatefulWidget {
  const OwnerBookingListMultiSelectScreen({super.key});

  @override
  ConsumerState<OwnerBookingListMultiSelectScreen> createState() =>
      _OwnerBookingListMultiSelectScreenState();
}

class _OwnerBookingListMultiSelectScreenState
    extends ConsumerState<OwnerBookingListMultiSelectScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_isSelectionMode ? 'Pilih Pesanan' : 'Riwayat Pesanan'),
        actions: [
          if (_isSelectionMode)
            IconButton(
